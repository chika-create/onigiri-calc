...
function Term() {
  return (
    <Box>
      ...
      <TitleH2>購入手続後の契約の申込みの撤回又は解除</TitleH2>
      <Text>
      ...
      <TitleH2>サービスの内容の変更、追加、停止</TitleH2>
      <Text>
        当社は、利用者に事前の通知をすることなく、本サービスの内容の全部又は一部を変更、追加又は停止する場合があり、利用者はこれをあらかじめ承諾するものとします。
      </Text>

      <TitleH2>個人情報</TitleH2>
      <Text>
        当社は、利用者による本サービスの利用によって取得する個人情報を、当社のプライバシーポリシーに従い、適切に取り扱います。
      </Text>

      <TitleH2>禁止事項</TitleH2>
      <Text>利用者は、次の行為を行うことはできません。</Text>
      <Text>本サービスの運営を妨げ、又はそのおそれのある行為</Text>
      <Text>他の利用者による本サービスの利用を妨害する行為</Text>
      <Text>本サービスにかかる著作権その他の権利を侵害する行為</Text>
      <Text>
      ...
      <TitleH2>反社会的勢力の排除</TitleH2>
      <Text>利用者は、当社に対し、次の事項を確約します。</Text>
      <Text>
      ...
      <Text>自ら又は第三者を利用して、次の行為をしないこと。</Text>
      <Text>相手方に対する脅迫的な言動又は暴力を用いる行為</Text>
      <Text>法的な責任を超えた不当な要求行為</Text>
      <Text>
        偽計又は威力を用いて相手方の業務を妨害し、又は信用を毀損する行為
      </Text>

      <TitleH2>免責事項</TitleH2>
      <Text>
      ...
      <Text>本サービスが将来にわたって存続し続けること</Text>
      <Text>
      ...
      <Text>本規約を変更する旨</Text>
      <Text>変更後の本規約の内容</Text>
      <Text>効力発生日：2023年9月1日</Text>

      <TitleH2>準拠法、裁判管轄</TitleH2>
      <Text>本規約は、日本法に準拠して解釈されます。</Text>
      <Text>
